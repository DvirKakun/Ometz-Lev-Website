...
export const PRE_QUESTIONNAIRE_FIELDS = {
  ...
  hasSurgeryOrInjury: {
    header: "האם עבר ניתוח או פציעה?",
    key: "hasSurgeryOrInjury",
  },
...
export function convertPreQuestionnaireToSheetRow(
  ...
  return {
    ...
    [PRE_QUESTIONNAIRE_FIELDS.allergiesDetails.header]:
      data.allergiesDetails || "",
    [PRE_QUESTIONNAIRE_FIELDS.hasSurgeryOrInjury.header]:
      data.hasSurgeryOrInjury,
    ...
    [PRE_QUESTIONNAIRE_FIELDS.contactPhone.header]: formatPhoneNumber(
      data.contactPhone,
    ),
