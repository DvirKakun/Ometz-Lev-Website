...
const AccessibilityPage: React.FC = () => {
  ...
  return (
    <>
      <SEOMeta
        title="הצהרת נגישות | אומץ לב"
        description="הצהרת הנגישות של אתר אומץ לב. המחויבות שלנו לנגישות דיגיטלית וזכויות של אנשים עם מוגבלויות."
        noindex={true}
        nofollow={true}
      />
            ...
            <div className="prose prose-lg max-w-none text-right" dir="rtl">
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  אומץ לב מחויבת להנגשת האתר שלה לאנשים עם מוגבלויות. אנו פועלים
                  ליצירת חוויית גלישה נגישה ונוחה לכל המשתמשים, בהתאם לתקן
                  הישראלי 5568 ולהנחיות WCAG 2.1 ברמה AA.
                </p>
              </motion.section>
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  האתר תוכנן להיות תואם לרמת נגישות AA של תקן WCAG 2.1, ועונה על
                  דרישות התקן הישראלי 5568.
                </p>
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-4">
                  <h3 className="font-semibold text-green-800 mb-2">
                    ✅ תכונות נגישות שיושמו:
                  </h3>
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  למרות המאמצים שלנו, ייתכן שחלק מהתכנים באתר עדיין לא נגישים
                  במלואם:
                </p>
                <ul className="list-disc list-inside text-slate-600 space-y-2 mb-4">
