          ...
          <div className="prose prose-lg max-w-none text-right" dir="rtl">
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                ...
                ("החברה"). השימוש באתר או בשירותים מהווה הסכמה מלאה לתנאים אלה.
              </p>
            </motion.section>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                השימוש במידע האישי שלך כפוף למדיניות הפרטיות שלנו. אנו מתחייבים
                לשמור על פרטיותך ולא לשתף מידע אישי עם צדדים שלישיים ללא הסכמתך.
              </p>
            </motion.section>
