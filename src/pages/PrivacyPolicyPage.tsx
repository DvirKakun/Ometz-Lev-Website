  ...
  return (
    <>
      <SEOMeta
        ...
        description="מדיניות הפרטיות של אומץ לב - הגנה על הפרטיות שלכם, איסוף מידע, שימוש בעוגיות ושמירה על נתונים אישיים."
        noindex={true}
        nofollow={true}
      />
            ...
            <div className="prose prose-lg max-w-none text-right" dir="rtl">
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  ...
                  "שלנו") אוספת, משתמשת ומגינה על המידע האישי שלך. השימוש באתר
                  זה מהווה הסכמה למדיניות פרטיות זו.
                </p>
              </motion.section>
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  אנו לא נמכור, נשכיר או נשתף את המידע האישי שלך עם צדדים
              ...
              >
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  אנו נוקטים אמצעי אבטחה מתאימים כדי להגן על המידע האישי שלך
                  מפני גישה לא מורשית, שינוי, גילוי או השמדה.
                </p>
              </motion.section>
