...
export const schoolProgram: SchoolProgram = {
  ...
  summary: {
    description:
      "אומץ להתמודד עם קושי ופחד ולב לנתינה, לחמלה ולאהבה. הכלבים מסקרנים את הילדים ולרובם גורמים אושר ושמחה. ההשפעה על בעלי חיים תורמת לילדים תחושת ביטחון, שמחת חיים, קשיבות, אחריות ורכות. הילדים לומדים ליצור דיאלוג מכבד עם עצמם ועם הסביבה, מפנימים התנהגויות של אמפתיה, פרידה, דיבור רך ויצירת קשר, ויחסי שיתוף פעולה.",
    mainMessages: [
      "התמודדות עם פחד",
      "פיתוח אומץ לב",
      "נתינה",
  ...
  programLink:
    "https://apps.education.gov.il/tyhnet/public/#/tochniyot?id=9695",
};
