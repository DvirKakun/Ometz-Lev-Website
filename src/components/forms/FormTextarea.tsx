      ...
      <div className="relative">
        <textarea
          ...
          className={`w-full px-2 py-1 ${
            Icon ? "pr-7" : ""
          } bg-slate-50 border border-slate-300 rounded text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 text-right resize-none text-xs ${
