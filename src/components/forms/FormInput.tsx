      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-2 py-1 ${
            Icon ? "pr-7" : ""
          } bg-slate-50 border border-slate-300 rounded text-slate-900 placeholder-slate-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-200 focus-visible:border-primary-200 text-right text-xs ${
