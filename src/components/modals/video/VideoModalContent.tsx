    ...
    >
      <div dir="rtl" className="p-4 sm:p-6 pb-8">
        <DialogHeader className="mb-6 text-right">
          <DialogTitle className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2 text-right leading-tight whitespace-pre-wrap">
            {video.title}
          </DialogTitle>
          ...
          {video.subtitle && (
            <p className="text-lg text-slate-600 mb-4 text-right whitespace-pre-wrap">
              {video.subtitle}
            </p>
          )}
        </DialogHeader>
